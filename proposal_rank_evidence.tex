...
\begin{enumerate}
    ...
    \item \textbf{Claim:}  If $\mathrm{rank}(\mathbf{D}_{\mathrm{all}}) = \mathrm{rank}(\mathbf{D}_2) = 15$
          is confirmed on experimental data, it constitutes evidence that all multi-slit
          interference in this system decomposes into two-slit terms, consistent with
          $I_3 = 0$ and the Born rule.
\end{enumerate}
